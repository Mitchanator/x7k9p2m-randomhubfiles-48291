...
local SETTINGS = {
    ...
    KEY_DB_URL = "https://pastebin.com/raw/1X5iW7Pj",  -- ← CHANGE THIS TO YOUR REAL RAW PASTEBIN LINK
...
Tabs.Home = {
    Build = function(container)
        ...
        desc.Text = "Personal script hub with timed license key.\n\nEnter your key to unlock.\nFeatures → Auto Farm tab"
